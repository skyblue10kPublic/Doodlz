...
public class MainActivityFragment extends Fragment {
   ...
   private void confirmErase() {
      ...
      ColorDialogFragment colorDialogErase = new ColorDialogFragment();
      Bundle args = new Bundle();
      args.putInt("eraseSetColor",0);
      colorDialogErase.setArguments(args);
      colorDialogErase.show(getFragmentManager(), "color dialog");
